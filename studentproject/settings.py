...
SECRET_KEY = 'django-insecure-64+b(j&u)mg42+5r=rlqrtg-7%!94ld91u3e-7rdu54me+cc0q'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = (
    str(BASE_DIR.joinpath('adminapp', 'static')),
    str(BASE_DIR.joinpath('studentapp', 'static')),
)
